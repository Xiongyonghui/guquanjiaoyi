...
- (void)viewDidLoad {
   ...
   // _sureBtn.layer.borderWidth = 1;
    ...
    _sureBtn.backgroundColor = [ConMethods colorWithHexString:@"c40000"];
...
-(void)requestMethods {
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERmodifyLoginPwdSubmit] parameters:paraDic success:^(AFHTTPRequestOperation *operation, id responseObject) {
