...
-(void)requestMyGqzcPaging{
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERapplySaveMoneySubmit] parameters:paraDic success:^(AFHTTPRequestOperation *operation, id responseObject) {
