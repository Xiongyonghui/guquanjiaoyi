...
-(void)requestMethods{
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERmodifyTranPwdSubmit] parameters:paraDic success:^(AFHTTPRequestOperation *operation, id responseObject) {
