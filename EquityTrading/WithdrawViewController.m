...
- (void)viewDidLoad
{
    ...
    scrollView.backgroundColor = [ConMethods colorWithHexString:@"eeeeee"];
    
    [self.view addSubview:scrollView];
    
    [self requestRecharAndWithdrwMethods];
    
    [self getScrollViewUI];
}

//请求数据方法
-(void)requestRecharAndWithdrwMethods {
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERapplySaveAndOutMoneyIndex] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"success"] boolValue]){
            ...
            self.dic = [responseObject objectForKey:@"object"];
...
-(void)getScrollViewUI {
    ...
    view1.backgroundColor = [ConMethods colorWithHexString:@"fdfdfd"];
    ...
    tiplabBank.textColor = [ConMethods colorWithHexString:@"333333"];
    ...
    tiplabBankTail.textColor = [ConMethods colorWithHexString:@"999999"];
    ...
    UIView *viewFirst = [[UIView alloc] initWithFrame:CGRectMake(0, 95, ScreenWidth, 175)];
     viewFirst.backgroundColor = [ConMethods colorWithHexString:@"fdfdfd"];
 ...
 //可用余额
    ...
    moneyLabTip.textColor = [ConMethods colorWithHexString:@"999999"];
    ...
    [valueLabelTip setTextColor:[ConMethods colorWithHexString:@"fe8103"]];
    ...
    [flagLabel setTextColor:[ConMethods colorWithHexString:@"999999"]];
    ...
    lineTip.backgroundColor = [ConMethods colorWithHexString:@"eeeeee"];
    ...
    tipfei.textColor = [ConMethods colorWithHexString:@"999999"];
    tipfei.text = @"手续费";
    ...
    tipfeiVule.textColor = [ConMethods colorWithHexString:@"333333"];
    ...
    [flagLabelVule setTextColor:[ConMethods colorWithHexString:@"999999"]];
    ...
    lineTipVule.backgroundColor = [ConMethods colorWithHexString:@"eeeeee"];
    ...
    tiplabchanger.textColor = [ConMethods colorWithHexString:@"999999"];
    tiplabchanger.text = @"提现金额";
    ...
    changerText.layer.borderColor = [ConMethods colorWithHexString:@"eeeeee"].CGColor;
    ...
    changerText.textColor = [ConMethods colorWithHexString:@"333333"];
    ...
    [bigLab setTextColor:[ConMethods colorWithHexString:@"999999"]];
    ...
    viewSecond.backgroundColor = [ConMethods colorWithHexString:@"fdfdfd"];
    
    UILabel *tiplabPW = [[UILabel alloc] initWithFrame:CGRectMake(10, 15, 70, 15)];
    tiplabPW.font = [UIFont systemFontOfSize:15];
    tiplabPW.textColor = [ConMethods colorWithHexString:@"999999"];
    tiplabPW.text = @"交易密码";
    ...
    passWord.textColor = [ConMethods colorWithHexString:@"333333"];
   ...
   // 动态码
    ...
    viewthird.backgroundColor = [ConMethods colorWithHexString:@"fdfdfd"];
    
    
    UILabel *tiplabCode = [[UILabel alloc] initWithFrame:CGRectMake(10, 15, 70, 15)];
    tiplabCode.font = [UIFont systemFontOfSize:15];
    tiplabCode.textColor = [ConMethods colorWithHexString:@"999999"];
     tiplabCode.text = @"动态码";
    ...
    numberCode.textColor = [ConMethods colorWithHexString:@"333333"];
    ...
    sheetLab.backgroundColor = [ConMethods colorWithHexString:@"087dcd"];
...
-(void)requestMyGqzcPaging{
    ...
    [paraDic setObject:changerText.text forKey:@"zzje"];
    [paraDic setObject:numberCode.text forKey:@"yzm"];
    [paraDic setObject:[[Base64XD encodeBase64String:passWord.text] strBase64] forKey:@"jymm"];
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERapplyOutMoneySubmit] parameters:paraDic success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"success"] boolValue] == YES){
            ...
            [self requestMethods:[[responseObject objectForKey:@"object"] objectForKey:@"FID_SQH"]];
...
-(void)requestMethods {
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERsendVcode] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)requestMethods:(NSString *)str {
    ...
    [paraDic setObject:str forKey:@"sqh"];
    ...
    [manager POST:[NSString stringWithFormat:@"%@%@",SERVERURL,USERcheckResult] parameters:paraDic success:^(AFHTTPRequestOperation *operation, id responseObject) {
        
        if ([[responseObject objectForKey:@"success"] boolValue]){
            NSLog(@"JSON: %@", responseObject);
            
            
            if ([responseObject objectForKey:@"object"] == nil || [[responseObject objectForKey:@"object"] count] == 0) {
                
                [[HttpMethods Instance] activityIndicate:NO
                                              tipContent:@"提现结果正在处理，请到转账充值中查询"
                                           MBProgressHUD:nil
                                                  target:self.navigationController.view
                                         displayInterval:3];
                ...
                [[HttpMethods Instance] activityIndicate:NO
                                              tipContent:[[[responseObject objectForKey:@"object"] objectAtIndex:0] objectForKey:@"FID_JGSM"]
                                           MBProgressHUD:nil
                                                  target:self.navigationController.view
                                         displayInterval:3];
...
- (void)resignKeyboard:(id)sender
{
    ...
    [numberCode resignFirstResponder];
}
